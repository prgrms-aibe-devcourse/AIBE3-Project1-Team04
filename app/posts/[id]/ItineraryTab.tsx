    ...
    <div>
      ...
      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 mb-8 border border-blue-100">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          <div className="bg-white rounded-lg p-4 text-center shadow-sm border border-blue-100">
            <div className="text-2xl font-bold text-blue-600 mb-1">{post.totalDays}일</div>
            <div className="text-sm text-gray-600">총 기간</div>
          </div>
          <div className="bg-white rounded-lg p-4 text-center shadow-sm border border-blue-100">
            <div className="text-2xl font-bold text-green-600 mb-1">{actualTotalBudget.toLocaleString()}원</div>
          ...
          <div className="bg-white rounded-lg p-4 text-center shadow-sm border border-blue-100">
            <div className="text-2xl font-bold text-orange-600 mb-1">{post.regions.length}개</div>
          ...
          <div className="mt-4 bg-white rounded-lg p-4 shadow-sm border border-blue-100">
            <div className="flex items-center justify-between text-sm">
              ...
              <span className="font-semibold text-gray-800">
                {Math.round(actualTotalBudget / post.places.length).toLocaleString()}원
              </span>
            </div>
          </div>
        )}
      ...
      <div className="space-y-6">
        ...
        {post.places.map((place, index) => (
          <div key={place.id} className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-all duration-200 hover:border-blue-200">
            {/* 순서 표시 */}
              ...
              <div className="flex-1">
                <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-3">
                  ...
                  <div className="text-right bg-gray-50 rounded-lg p-3 lg:min-w-[120px]">
                    ...
                    <div className="font-semibold text-gray-800">{place.visitTime}</div>
                  </div>
                </div>
