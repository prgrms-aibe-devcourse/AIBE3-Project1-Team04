function ActivitySummary({ mockMyPosts, mockMyPlaces }: { mockMyPosts: any; mockMyPlaces: any }) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
      <div className="bg-white rounded-xl shadow-sm p-6 text-center">
        ...
        <h3 className="text-2xl font-bold text-gray-900 mb-1">{mockMyPosts.length}</h3>
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 text-center">
        ...
        <h3 className="text-2xl font-bold text-gray-900 mb-1">{mockMyPlaces.length}</h3>
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 text-center">
        ...
        <h3 className="text-2xl font-bold text-gray-900 mb-1">165</h3>
